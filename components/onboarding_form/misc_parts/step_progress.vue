...
import { onboarding_question } from "~/config/forms";
...
const steps = ref(onboarding_question);
</script>
...
<template>
  <div class="hidden lg:flex flex-col items-start gap-y-2">
    <template v-for="(step, index) in steps" :key="index">
      <div
        class="flex items-center justify-between gap-x-[30px] hover:cursor-pointer"
      >
        <div
          :class="{
