  ...
  >
    ...
    <g id="SVGRepo_iconCarrier">
      ...
      <g id="xxx-word">
        <path
          class="fill-[#101010]"
          d="M325,105H250a5,5,0,0,1-5-5V25a5,5,0,1,1,10,0V95h70a5,5,0,1,1,0,10Z"
        ></path>
        <path
          class="fill-[#101010]"
        ...
        <path
          class="fill-[#101010]"
          d="M203.38,220.69h-7.62v-5.27a7.14,7.14,0,0,1,1.07-4.18,25,25,0,0,1,4.71-4.34q5.55-4.26,5.55-9a7.59,7.59,0,0,0-2.17-5.7,7.75,7.75,0,0,0-5.64-2.11q-8,0-9.49,11.13l-8.52-1.52q.78-8.32,6.15-13.07a18.78,18.78,0,0,1,12.87-4.75,17.67,17.67,0,0,1,12.34,4.43,14.3,14.3,0,0,1,4.88,11,14.82,14.82,0,0,1-1.35,6.23,14.48,14.48,0,0,1-3.07,4.57,92,92,0,0,1-7.27,5.68,5.52,5.52,0,0,0-2,2.21A16,16,0,0,0,203.38,220.69Zm1.56,5.55V236h-9.18v-9.77Z"
        ></path>
      </g>
    </g>
  </svg>
